...
@Component({
  selector: 'app-geleterie',
  templateUrl: './gelaterie.page.html',
  styleUrls: ['./gelaterie.page.scss'],
})
export class GelateriePage implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.foodList = this.foodList.filter(currentFood => {
      if (currentFood.title && "Gelateria") {
